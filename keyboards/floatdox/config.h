...
#define PRODUCT_ID 0xF1D6
#define DEVICE_VER 0x0001
#define MANUFACTURER FloatLab

// clang-format off
#if defined(__riscv)
#    define PRODUCT FloatDox 1.0 RISC-V
#elif defined(__arm__)
#    define PRODUCT FloatDox 1.0 ARM
#endif
...
#define MATRIX_COL_PINS \
    { B12, B13, B9, B8, B5, A10, A6, A8 }
#define MATRIX_ROW_PINS \
    { B4, B15, B14, B2, B1 }
#define MATRIX_COL_PINS_RIGHT \
    { A8, A6, A10, B5, B8, B9, B13, B12 }
