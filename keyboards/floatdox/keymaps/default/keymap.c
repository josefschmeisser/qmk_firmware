...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT( \
    ...
    KC_CAPS        , KC_LGUI       , KC_LALT       , TT(1)         , TT(2)                         , KC_SPC        , LT(3, KC_ESC) , LT(3, KC_DEL) , KC_SPC                        , KC_LEFT       , KC_DOWN       , KC_UP         , KC_RGHT       , KC_RCTL         \
  ),
  [_SYM] = LAYOUT( \
    _______        , _______       , _______       , _______       , _______       , _______       , _______       ,                                 _______       , _______       , _______       , _______       , _______       , _______       , _______       , \
    KC_TAB         , _______       , _______       , RALT(KC_E)    , _______       , _______       , _______       ,                                 _______       , _______       , RALT(KC_U)    , _______       , RALT(KC_O)    , _______       , _______       , \
    _______        , RALT(KC_A)    , RALT(KC_S)    , _______       , _______       , _______       , KC_GRV        , KC_MUTE       , KC_MPLY       , KC_QUOT       , _______       , _______       , _______       , _______       , _______       , _______       , \
    _______        , _______       , _______       , _______       , _______       , _______       , _______       , _______       , _______       , _______       , _______       , _______       , _______       , _______       , KC_SLSH       , _______       , \
  ...
  [_FN] = LAYOUT( \
    ...
    KC_NO          , TG(2)         , CL_SWAP       , CL_NORM       , KC_NO         , KC_NO         , KC_NO         ,                                 KC_NO         , KC_NUMLOCK    , KC_KP_7       , KC_KP_8       , KC_KP_9       , KC_PSLS       , KC_DEL        , \
  ...
  [_NAV] = LAYOUT( \
    ...
    _______        , _______       , _______       , KC_NO         , KC_NO                         , KC_NO         , KC_NO         , KC_NO         , KC_NO                         , KC_NO         , KC_NO         , KC_NO         , KC_NO         , _______         \
  )
};
...
static void render_base_layer_indicator(void) {
    static const char PROGMEM base_indicator[] = {
        
    };
...
static void render_sym_layer_indicator(void) {
    static const char PROGMEM sym_indicator[] = {
        
    };
...
static void render_fn_layer_indicator(void) {
    static const char PROGMEM fn_indicator[] = {
        
    };
...
static void render_nav_layer_indicator(void) {
    static const char PROGMEM nav_indicator[] = {
        ...
        0xc2, 0x1e, 0x7e, 0xfe, 0x02, 0x02, 0xfe, 0xfe, 0xfe, 0x7e, 0x06, 0x82, 0x82, 0x06, 0x7e, 0xfe,
        0xfe, 0xfe, 0xf2, 0x02, 0x06, 0xfe, 0xfe, 0x06, 0x02, 0xf2, 0xfe, 0xfe, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7f, 0x40, 0x40,
        0x7f, 0x7e, 0x78, 0x43, 0x40, 0x40, 0x7f, 0x7f, 0x4f, 0x40, 0x60, 0x79, 0x79, 0x60, 0x40, 0x4f,
        0x7f, 0x7f, 0x7f, 0x7e, 0x40, 0x41, 0x41, 0x40, 0x7e, 0x7f, 0x7f, 0x7f, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
    };
